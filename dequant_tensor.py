...
def dequantize_blocks_BF16(blocks):
...
def dequantize_blocks_Q5_1(blocks, block_size, dtype=None):
...
def dequantize_blocks_Q5_0(blocks, block_size, dtype=None):
    n_blocks = blocks.shape[0]
...
def dequantize_blocks_Q4_1(blocks, block_size, dtype=None):
    n_blocks = blocks.shape[0]
...
def dequantize_blocks_Q4_0(blocks, block_size, dtype=None):
    n_blocks = blocks.shape[0]
...
def dequantize_blocks_Q6_K(blocks, dtype=None):
    n_blocks = blocks.shape[0]
...
def dequantize_blocks_Q5_K(blocks, dtype=None):
    n_blocks = blocks.shape[0]
...
def dequantize_blocks_Q4_K(blocks, dtype=None):
    n_blocks = blocks.shape[0]
...
def dequantize_blocks_Q3_K(blocks, dtype=None):
    n_blocks = blocks.shape[0]
...
def dequantize_blocks_Q2_K(blocks, dtype=None):
    n_blocks = blocks.shape[0]
